...
@implementation SDAuthorizationManager

+ (void)checkAuthorization:(SDAuthorizationType)type firstRequestAccess:(void (^)(void))requestAccess completion:(void (^)(BOOL))completion {
    
    switch (type) {
        case SDAuthorizationTypeCamera: {
            ...
            break;
        case SDAuthorizationTypePhotoLibrary: {
            ...
            break;
        case SDAuthorizationTypeMicrophone: {
